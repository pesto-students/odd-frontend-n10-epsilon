...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      "gradient-to-br":
        "linear-gradient(to bottom right, var(--gradient-stops))",
      "gradient-to-b": "linear-gradient(to bottom, var(--gradient-stops))",
      "gradient-to-bl":
        "linear-gradient(to bottom left, var(--gradient-stops))",
    ...
    boxShadow: {
      ...
      largest: "0 4px 4px 0 rgba(0, 0, 0, .20), 0 8px 8px 0 rgba(0, 0, 0, .10)",
      "inner-largest":
        "inset 0 4px 4px 0 rgba(0, 0, 0, .20), 0 8px 8px 0 rgba(0, 0, 0, .10)",
