...
class OrderInfoReaders {
    ...
    public static PickUpPersonName(_object: any) {
        return _.get(_object, ["pickup_info", "contact_person_name"], "");
    }

    public static PickUpPersonPhoneNumber(_object: any) {
        return _.get(_object, ["pickup_info", "contact_person_number"], "");
    }

    public static PickUpTitleAddress(_object: any) {
        return `${_.get(_object, ["pickup_info", "add_1"], "-")} ${_.get(_object, ["pickup_info", "add_2"], "-")}`;
    }
    ...
    public static DropOffPersonName(_object: any) {
        return _.get(_object, ["drop_off_info", "contact_person_name"], "");
    }

    public static DropOffPersonPhoneNumber(_object: any) {
        return _.get(_object, ["drop_off_info", "contact_person_number"], "");
    }

    public static DropOffTitleAddress(_object: any) {
        return `${_.get(_object, ["drop_off_info", "add_1"], "-")} ${_.get(_object, ["drop_off_info", "add_2"], "-")}`;
    }
    ...
    public static DriverFullName(_object: any) {
        return `${_.get(_object, ["driver_id", "first_name"], "-")} ${_.get(_object, ["driver_id", "last_name"], "-")}`;
    }
    ...
    public static UserImage(_object: any) {
        const value = _.get(_object, ["user_id", "image"]);
        return !_.isEmpty(value) ? value : "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60";
    }
}
